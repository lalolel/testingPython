from random import randint  # Import only randint from the random module
...
def play_RPS():
    ...
    # Generate a random choice for the computer using randint
    computer_choice = options[randint(0, 2)]  # Selects a random index from 0 to 2
